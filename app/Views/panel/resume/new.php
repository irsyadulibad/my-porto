...
<?= $this->section('content') ?>
	<div class="row justify-content-center">
		<div class="col-md-5">
			<div class="card">
				<form action="/panel/resume" method="post">
				<div class="card-body">
					...
					<div class="form-group row">
						<div class="col-md-6">
							...
							<input type="number" name="begin_year" id="begin" class="form-control" value="<?= old('begin_year') ?>">
							<small class="text-danger">
								<?= $errors['begin_year'] ?? '' ?>
							</small>
						</div>
						<div class="col-md-6">
							...
							<input type="text" name="end_year" id="end" class="form-control" value="<?= old('end_year') ?>">
							<small class="text-danger">
								<?= $errors['end_year'] ?? '' ?>
							</small>
						</div>
					...
					<div class="form-group">
						...
						<textarea name="description" id="description" class="form-control" style="height: 9.8em;"><?= old('description') ?></textarea>
						<small class="text-danger">
							<?= $errors['description'] ?? '' ?>
						</small>
					</div>
